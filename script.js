        ...
        const zonesURL = "https://raw.githubusercontent.com/ten8mystery/Holy-Salmon-1/refs/heads/main/data/zonesnew.json";
        ...
        settings.addEventListener('click', () => {
            ...
            const popupBody = document.getElementById('popupBody');
            popupBody.innerHTML = `
            <button id="settings-button" onclick="darkMode()">Toggle Theme</button>
            <br><br>
            <button id="settings-button" onclick="tabCloak()">Hide your salmon</button>
            <br>
            `;
            popupBody.contentEditable = false;
            document.getElementById('popupOverlay').style.display = "flex";
        ...
        function loadPrivacy() {
            ...
            popupBody.innerHTML = `
                <div style="max-height: 60vh; overflow-y: auto;">
                    ...
                    <p>This Privacy Notice for Holy Salmon (GN-MATH FORK) ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:</p>
                    <ul>
